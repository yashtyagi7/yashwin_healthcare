...
const hero = () => {
  return <>
    <section className="hero p-4 bg-white">
        ...
        <div className="row">
          <div className="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 hero-details">
            <div className="row g-4 justify-content-center justify-content-md-between align-items-center">
              ...
              <div className="col-6 col-md-4 col-lg-2">
                <div className="card text-center m-auto">
                  <img src={orders1} className="card-img-top img-fluid m-auto" alt="Timely Delivery" />
                  <div className="card-body">
                    <p className="card-text mb-0">Timely Delivery</p>
                  </div>
                </div>
              </div>
